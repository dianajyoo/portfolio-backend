...
pmInsights = Project.create(name: "PM Insights", description: "Analyzes and provides insight on your sleep habits", tools: "React, Redux, Ruby on Rails, HTML, CSS, Semantic UI React", gif: "", summary: "PM Insights is a React front end and Ruby on Rails back end web application that dabbles with data visualization. PM Insights was born out of my desire to incorporate hardware and real data in my project. The app displays your sleep data using Fitbit Web API. It also allows you to add, edit, and delete sleep goals.")
